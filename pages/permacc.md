...
Unlike the Internet Archive or the University of Idaho Library's [Archive-It collections](https://archive-it.org/home/uidaholib), Perma.cc does not crawl the open web. 
All pages stored in the archive are captured by individual users and provided with a short "permalink".
...
The clear focus on supporting academic citation makes Perma.cc a good choice for preserving sources in scholarly writing.
Since the permalinks are relatively small (e.g. `https://perma.cc/T8YP-BFC9`), they are handy to add to citations and references.

As a Registrar Library, we can sponsor University of Idaho affiliated accounts, providing support and unlimited permalink creation.

## Get Started

Establish a sponsored account:

1. [Create an account](https://perma.cc/sign-up) using your U of I email. Individual accounts start with only 10 free trial links. 
2. Contact [Evan Williamson](https://www.lib.uidaho.edu/about/people/ewilliamson.html) or [Rebecca Hastings](https://www.lib.uidaho.edu/about/people/rhastings.html) in the Library to consult about your use case. We will establish an "Organization" for you that will allow you to create unlimited permalinks.
3. Create permalinks, cite, and ask us questions!

## Create permalinks

{% include feature/image.html objectid="https://objects.lib.uidaho.edu/webarchive/permacreate.png" alt="perma link creation interface" %}

- Log into to your Perma.cc account.
- Paste a full URL into the form box.
- Select your "Organization" and any sub-folder where you want to save the link.
- Click "Create Perma Link".
- The capture process will take awhile. When complete you will be redirected to the new permalink (if something goes wrong you may get an error message). 
- Copy the permalink URL from the address bar in your browser. 

{% include feature/image.html objectid="https://objects.lib.uidaho.edu/webarchive/permalink.png" alt="perma link menu area" %}
...
Most of your links will be part of your sponsored "Organization".
